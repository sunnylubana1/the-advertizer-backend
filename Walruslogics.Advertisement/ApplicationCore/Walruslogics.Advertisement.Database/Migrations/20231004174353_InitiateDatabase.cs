        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleKey = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LoginProvider = table.Column<string>(type: "char(1)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    EmailChanged = table.Column<DateTime>(type: "datetime2", nullable: false),
              ...
              migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassowrdResetToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TokenExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastForgotPasswordDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Description", "Name", "NormalizedName", "RoleKey" },
                values: new object[,]
                {
                    { 1L, null, "Super Admin Can not be archived.", "Super Admin", "Super Admin", "SuperAdmin" },
                    { 2L, null, "Admin Role.", "Admin", "Admin", "Admin" },
                    { 3L, null, "User Role.", "User", "User", "User" }
                });
